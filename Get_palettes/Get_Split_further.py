...
from Get_Palette_by_Two_center.space_2_space import rgbs_2_hss_colormath, rgbs_2_hsvs_colormath, rgbs_2_abs, rgb_2_lab
import numpy as np
...
def Broken_down_further_Get_Two_center(result_palette,result_weight):
    return_base = 0;
    palettes_not_sorted_hsv = rgbs_2_hss_colormath(result_palette);
